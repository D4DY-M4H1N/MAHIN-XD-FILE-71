...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : D4DY-M4H1N SHUVO");time.sleep (0.03)
    print("             [*]. FACEBOOK   : D4DY-M4H1N");time.sleep (0.03)
    print("             [*]. GITHUB     : D4DY-M4H1N");time.sleep (0.03)   
    print("             [*]. VERSION    : 2.5.6");time.sleep (0.03)
    print("             [*]. TOOL TYPE  : FREE");time.sleep (0.03)
    print("             [*]. IP ADDRESS : [%s]\n"%(IP));time.sleep(0.01)
